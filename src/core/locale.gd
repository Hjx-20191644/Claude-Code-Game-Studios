...
static var _dict_en := {
	...
	# Victory
	"victory": "Victory!",
	"victory_subtitle": "The final boss has fallen",
	...
	"total_shards_earned": "Total Shards Earned",
	...
	"tutorial_ranged": "Ranged Attack",
	"tutorial_dodge": "Dodge",
	"tutorial_pause": "Pause",
	"tutorial_dismiss": "(fades on first action)",
	# Keybindings
	"keybinds": "Keybindings",
	"kb_move_up": "Move Up",
	"kb_move_down": "Move Down",
	"kb_move_left": "Move Left",
	"kb_move_right": "Move Right",
	"kb_melee_attack": "Melee Attack",
	"kb_ranged_attack": "Ranged Attack",
	"kb_dodge": "Dodge",
	"kb_pause": "Pause",
...
static var _dict_zh := {
	...
	"continue_endless": "继续无尽挑战",
	# Statistics
	"statistics": "生涯统计",
	"total_kills": "总击杀",
	"total_deaths": "总死亡",
	"highest_wave": "最高波次",
	"total_shards_earned": "累计碎片",
	"total_victories": "通关次数",
	"unlock_progress": "解锁进度",
	# Tutorial
	"tutorial_title": "操作说明",
	"tutorial_move": "移动",
	"tutorial_melee": "近战攻击",
	"tutorial_ranged": "远程攻击",
	"tutorial_dodge": "闪避",
	"tutorial_pause": "暂停",
	"tutorial_dismiss": "（首次操作后自动消失）",
	# Keybindings
	"keybinds": "按键设置",
	"kb_move_up": "上移",
	"kb_move_down": "下移",
	"kb_move_left": "左移",
	"kb_move_right": "右移",
	"kb_melee_attack": "近战攻击",
	"kb_ranged_attack": "远程攻击",
	"kb_dodge": "闪避",
	"kb_pause": "暂停",
	"kb_listening": "请按键...",
	"kb_reset": "重置",
